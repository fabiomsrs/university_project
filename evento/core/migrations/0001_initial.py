    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario_criador', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordenadores', models.ManyToManyField(related_name='minhas_trilhas', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
