# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-08-25 21:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_de_fim', models.DateField(null=True)),
                ('hora_fim', models.TimeField(null=True)),
                ('evento_principal', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='meus_eventos_satelites', to='evento.Evento')),
