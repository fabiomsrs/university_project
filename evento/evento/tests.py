...
class EventoTest(TestCase):
	...
	def test_get_todas_atividades(self):
		...
		local.save()
		atividade0 = Atividade(nome_atividade="teste", evento=evento, valor_atividade=10,descricao=" ",ispadrao=False,responsavel=responsavel,usuario_criador=user,horario_inicio=datetime.datetime(year=2005,month=1,day=1,hour=15),horario_final=datetime.datetime(year=2005,month=1,day=1,hour=16),local=local)
		atividade0.save()
...
class AtividadeTest(TestCase):
	def set_atividades_proibidas(self):
		...
		atividade2 = Atividade(nome_atividade="teste", evento=evento, valor_atividade=10,descricao=" ",ispadrao=False,responsavel=responsavel,usuario_criador=user,horario_inicio=datetime.datetime(year=2005,month=1,day=1,hour=15),horario_final=datetime.datetime(year=2005,month=1,day=1,hour=16),local=local)
		atividade2.save()
		atividade3 = Atividade(nome_atividade="teste1", evento=evento1, valor_atividade=10,descricao=" ",ispadrao=False,responsavel=responsavel,usuario_criador=user,horario_inicio=datetime.datetime(year=2005,month=1,day=1,hour=17),horario_final=datetime.datetime(year=2005,month=1,day=1,hour=18),local=local)
		atividade3.save()
